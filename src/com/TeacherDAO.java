...
public class TeacherDAO {
	...
	public static String changePassword(String username, String password){
		String query="update TEACHER set password=? where username=?";
	...
	public static String addQuestion(String id, String question, String answer){
	...
	public static String deleteQuiz(String id){
